...
func TestPerimeter(t *testing.T) {
	perimeterTests := []struct {
		...
		{name: "Right Triangle", shape: RightTriangle{Base: 12, Height: 6}, hasPerimeter: 31.41640786499874},
	}
...
func TestArea(t *testing.T) {
	areaTests := []struct {
		...
		{name: "Right Triangle", shape: RightTriangle{Base: 12, Height: 6}, hasArea: 36.0},
	}
